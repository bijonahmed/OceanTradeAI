<template>
  <title>Add Trading Category</title>
  <div>
                  ...
                  <div class="card-body">
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                      <div class="tab-pane fade active show" id="custom-tabs-three-home" role="tabpanel"
                        ...
                        <div class="row mb-3">
                          <label for="input-meta-description-1" class="col-sm-2 col-form-label">Additional Banner Image</label>
                          <div class="col-sm-10">
                            <input type="file" class="form-control"  ref="fileInput" accept="image/png,image/jpeg" @change="handleImageUpload" id="fileInput" />
                            <div class="row mt-3">
                              <div class="col-md-3" v-for="(image, index) in images" :key="index">
                                <div class="card">
                                  <img :src="image.url" class="card-img-top img-fluid" alt="Preview" style="width: 402px;height:105px;" />
                                  <div class="card-body">
...
const saveData = () => {
  ...
  axios.post('/trading/saveCategory', formData, {
    headers: {
