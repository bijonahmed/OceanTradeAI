<template>
    <div class="dashboard show">
        <title>Loan Return Payment Confirm</title>
                ...
                <div class="dashboard__main">
                    ...
                    <div class="row">
                        <div class="col-md-6 m-auto">
                            ...
                            <form class="withdraw_form wth_confirm" @submit.prevent="loanSubmit()" id="formrest">
                                ...
                                <div class="refer_body p-0">
                                    ...
                                    <div class="input_bt_group">
                                        ...
                                        <div style="display: none;">
                                            <strong id="deposit_amount" class="textToCopy"> {{ deposit_amount }}</strong>
                                        </div>
...
const loanSubmit = () => {
    ...
    axios
        .post("/loan/loanSendRequest", formData, { headers })
        .then((res) => {
