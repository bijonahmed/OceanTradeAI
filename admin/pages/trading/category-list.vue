<template>
    <title>Trading Category List</title>
    <div>
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/trading/add-category">New</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th class="text-left">Name</th>
                                                    <!-- <th class="text-left">Selected Graph</th> -->
                                                    <th class="text-center">Status</th>
                                                    <th class="text-center">Action</th>
                                                </tr>
                                            </tfoot>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/trading/alltradingCategoryList`, {
            params: {
                page: page,
                pageSize: pageSize,
