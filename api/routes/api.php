...
Route::middleware(['auth:api', CheckUserStatus::class])->group(function () {
    ...
    Route::group([
        ...
        Route::get('checkPayment', [UserController::class, 'checkPayment']);
        ...
        Route::post('addUserPaymentWallet', [UserController::class, 'addUserPaymentWallet']);
        ...
        Route::get('getwalletAddress', [UserController::class, 'getwalletAddress']);
    });
