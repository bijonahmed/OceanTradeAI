                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/trading/add-duration">New</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            ...
                                            <tbody>
                                                <tr v-for="item in productdata" :key="item.id">
                                                    ...
                                                    <td class="text-left">{{ item.hours }}</td> 
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/trading/tradingdurationList`, {
            params: {
                page: page,
                pageSize: pageSize,
